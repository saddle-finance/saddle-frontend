...
export const ARB_USD_SWAP_TOKEN_CONTRACT_ADDRESSES = buildAddresses({
  [ChainId.ARBITRUM]: "0xf002D9f706da112B01D2A0CBFD2e0aA61AFd1cDB",
...
export const FRAX_ARB_USD_SWAP_V2_TOKEN_CONTRACT_ADDRESSES = buildAddresses({
  [ChainId.ARBITRUM]: "0x537ADe9585A82C038fbA9C68EecD7d1be5D9858B",
...
const USDC_CONTRACT_ADDRESSES = buildAddresses({
  ...
  [ChainId.ARBITRUM]: "0x87D54eaB02098e7BC995b1cfC0c2d93Ce7239fd9",
  //[ChainId.MATICMUMBAI]: "0x87D54eaB02098e7BC995b1cfC0c2d93Ce7239fd9",
})
...
const USDT_CONTRACT_ADDRESSES = buildAddresses({
  ...
  [ChainId.ARBITRUM]: "0xEE440CEc7189d5835CA917427AC03A83Faf6f0cE",
  //[ChainId.MATICMUMBAI]: "0xEE440CEc7189d5835CA917427AC03A83Faf6f0cE",
})
...
const NUSD_CONTRACT_ADDRESSES = buildAddresses({
  [ChainId.ARBITRUM]: "0x64311c05BB859Fe1e72D0E41b3d63dD39b0aa0Fc",
...
const MIM_CONTRACT_ADDRESSES = buildAddresses({
  [ChainId.ARBITRUM]: "0x8E46906d5991EF77A41A33a18fB289894C1Ab649",
...
const FRAX_CONTRACT_ADDRESSES = buildAddresses({
  ...
  [ChainId.ARBITRUM]: "0x5FbD05BC60cf9Bd035125693DEB640ecba07f9Ca",
