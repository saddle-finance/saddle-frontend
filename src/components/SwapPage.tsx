...
// If local state gets to hooked into global state, please use the stateless version below.
...
//       <TopMenu activeTab={"swap"} />
//       <div className="content">
//         <SwapForm2 title="From" tokens={tokens} selected={selectedTokens[0]} />
//         <img src={require("../assets/icons/icon_change.svg")} alt="" />
//         <SwapForm2 title="To" tokens={tokens} selected={selectedTokens[1]} />
//         <div className="priceTable">
//           <span className="title">Price</span>
...
//           {error.message}
//         </div>
//         <button className={"swap " + classNames({ disabled: error.isError })}>
//           Swap
//         </button>
//         <div className={"info " + classNames({ showInfo: info.isInfo })}>
//           {info.message}
//         </div>
//         <Modal isOpen={confirmOpen} onClose={closeModal} />
//       </div>
//     </div>
//   )
// }
